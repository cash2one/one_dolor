...
var helpText = new PointText({
    point: [viewWidth2, helpBiasY - 5.5 * helpTextFontSize],
    justification: 'center',
    fillColor: 'black',
    fontSize: helpTextFontSize
});
helpText.content = '大朋友小朋友儿童节快乐！\n画个圆，只要像个圆就领红包啦！\n您是第12551人参加活动！\n\n  1、相似度 > 96% 获得0.5元红包。\n2、相似度 > 97% 获得1元红包。\n3、相似度 > 99% 获得5元红包\n\n  喏，加油。\n\n点此开始';
...
function encourage(perfection) {
    ...
    if (perfection < 0.1) {
        ...
        desc = '我就是完美,完美就是我！获得10元大红包！';
    }
    window.location.replace('/game/draw_circle/resultpage/?score=' + perfection + '&desc=' + desc);
}
