...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(P).2r(3(){13();1e();1p();14();1o()});3 1o(){4 K=$(".h-b").2b().V;K=u(K)-12;1h(K)}3 1h(g){g?g=g:g=12;$(A).1i(3(){4 s=$(A).1q();6(s>g){$(".h-b").r("h-b-V")}p{$(".h-b").y("h-b-V")}})};3 1P(){$(\'#1Y\').1R({2c:\'1N\',1L:1,1I:1,1K:B,21:B,1Q:e})}3 14(){4 X=u($(".w-1g-18:11").d("20")+"1d")-N 1b().1W();$(".w-1g-18").1T(3(i,o){4 E=u($(o).d("E")+"1d");$(o).1V({E:E,X:X,1Z:10,1X:"%H:%M:%S:%1M",1J:3(){$(o).m("计算中")}})})}3 1O(O,1f,19){4 J=N 1b();J.1S(J.2n()+19);P.15=O+\'=\'+1f+\';2m=\'+J}3 2k(O){4 Y=P.15.1a(\'; \');2i(4 i=0;i<Y.22;i++){4 T=Y[i].1a(\'=\');6(T[0]==O){l T[1]}}l\'\'}3 13(){$(".q-j").16(17,3(){Q()});$(".q-j").2s(3(){$(".q-j").2t()},3(){$(".q-j").16(17,3(){Q()})})}3 Q(){$(".q-j G").t("c:11").2q({2p:"-"+$(".2h G").t("c:11").U()+"2g"},27,3(){4 c=$(7);$(".q-j G").1B(\'<c 28="n-1c">\'+$(c).m()+\'</c>\');$(c).25()})}3 1e(){$(".h-b .b-1c a").2f("2e",3(){6($(7).R(\'.2d\')){6($(7).R(\'.f-k\')){$(7).y(\'f-k\').r(\'f-v\');F.D=$(7).t(\'.i-v\').d(\'W\')}p 6($(7).R(\'.f-v\')){$(7).y(\'f-v\').r(\'f-k\');F.D=$(7).t(\'.i-k\').d(\'W\')}p{$(7).y(\'f-v\').r(\'f-k\');F.D=$(7).t(\'.i-k\').d(\'W\')}}})}4 Z=0;3 1F(5){4 2j=$(5);4 I=u($(5).d(\'I\'));4 8=N 1x();8.1v="1F";8.I=I;8.1G=u($(5).d(\'1G\'));$.1s({1t:1u,1w:8,1y:"1l",1m:"1A",1z:3(5){6(5.1D==-1){$.1C(5.1n,3(){6(5.1H){F.D=5.1H}});l e}6(5.1D==1){6(5.L>0){$(".z").m(5.L);$(".z").2a(29);6(5.L>Z){$(".z").r("1E");24(3(){$(".z").y("1E")},23)}Z=5.L;l e}p{$(".z").26()}l e}p{$.1C(5.1n);l e}}})}4 9=2;4 C=B;4 x=0;3 1p(){$(A).1i(3(){6(x>0&&9>x){C=e;$(".9-1j").m("没有更多夺宝活动了~")}p{$(".9-1j").m("努力加载中...~")}4 1r=1k($(A).U())+1k($(A).1q())+2o;6($(P).U()<=1r){6(C==B){C=e;4 8=N 1x();8.9=9;8.1v="2l";$.1s({1t:1u,1w:8,1y:"1l",1m:"1A",1z:3(5){$(".1U-G").1B(5.m);C=B;9++;x=5.9.x}})}}})}',62,154,'|||function|var|obj|if|this|query|page||nav|li|attr|false||min_height|slider||box|down|return|html|||else|notice|addClass||find|parseInt|up||page_total|removeClass|nav_cart_num|window|true|stop|href|endtime|location|ul||buy_num|oDate|nav_top_height|cart_item_num||new|name|document|roll_news|is||arr2|height|top|data_url|timespan|arr|cur_num||first|50|init_notice|init_count_down|cookie|everyTime|3000|nums|iDay|split|Date|item|000|init_order_by|value|countdown|slideNavGoTop|scroll|load|parseFloat|POST|dataType|info|init_slide_top|init_auto_load_data|scrollTop|totalheight|ajax|url|AJAX_URL|act|data|Object|type|success|json|append|showErr|status|nav_cart_num_zoom|add_cart|data_id|jump|moveSlideQty|callback|captions|displaySlideQty|MS|vertical|setCookie|init_adv_slider|controls|bxSlider|setDate|each|tuan|count_down|getTime|format|marquee|interval|nowtime|auto|length|200|setTimeout|remove|hide|300|class|1000|fadeIn|offset|mode|last|click|bind|px|notice_board|for|btn_item|getCookie|load_index_list_data|expires|getDate|100|marginTop|animate|ready|hover|stopTime'.split('|'),0,{}))
