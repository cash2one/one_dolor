...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(1(){8()});1 8(){$(".5-0").6();$(".4-0").3();$(".5-0").9("7",1(){$(b).3();$(".4-0").6();$(".c-2 .a-2").f("d")});$(".4-0").9("7",1(){$(b).3();$(".5-0").6();$(".c-2 .a-2").e("d")})}',16,16,'box|function|list|hide|close|open|show|click|init_show_btn|bind|user|this|info|slow|slideUp|slideDown'.split('|'),0,{}))
