...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('f 3=0;$(W).R(5(){k($("#l"));$("#l").i("g",5(){o($("#l"))});$("#6").h(".O").i("g",5(){$("#6").H()})});5 o(2){a($.D($("#n").d())==""){$.j("请输入手机号码");C S}a(3>0)C;f c=T U();c.n=$("#n").d();c.Q="X";c.A=$(2).4("A");c.7=(2).4("7");$.K({L:P,M:c,m:"N",V:"16",19:5(8){a(8.y==1){$(2).4("3",8.3);k(2);$.18(8.p);$(2).4("7","")}q{a(8.y==-1){$("#6 .v .t").s("");f w=\'<9 b="1b"><u m="1c" b="1e" 1d="图形码" 1a="e"/><x E="\'+8.e+"&r="+I.J()+\'"  /></9>\'+\'<9 b="B"></9><9 b="B"></9>\'+\'<9 b="17"><u m="11" b="10" F="G" Z="确认"/></9>\';$("#6 .v .t").s(w);$("#6").Y();$("#6").h("x").i("g",5(){$(12).4("E",8.e+"&r="+I.J())});$("#6").h("u[F=\'G\']").i("g",5(){f 7=$.D($("#6").h("#e").d());a(7==""){$.j("请输入图形验证码")}q{$(2).4("7",7);$("#6 .v .t").s("");$("#6").H();o(2)}});a($(2).4("7")&&$(2).4("7")!=""){$.j(8.p,5(){$(2).4("7","")})}}q{$.j(8.p)}}}})}5 k(2){$(2).z();$(2).13(15,5(){3=14($(2).4("3"));3--;$(2).d("重新获取("+3+")");$(2).4("3",3);a(3<=0){$(2).z();$(2).d("点击获取验证码")}})}',62,77,'||btn|lesstime|attr|function|verify_image_box|verify_code|obj|div|if|class|query|val|verify_image|var|click|find|bind|showErr|init_sms_btn|sms_btn|type|mobile|do_send|info|else||html|verify_content|input|verify_form_box|html_str|img|status|stopTime|unique|blank|return|trim|src|name|confirm_btn|hide|Math|random|ajax|url|data|POST|verify_close_btn|AJAX_URL|act|ready|false|new|Object|dataType|document|send_sms_code|show|value|v_btn|button|this|everyTime|parseInt|1000|json|v_btn_box|showSuccess|success|id|v_input_box|text|placeholder|v_txt'.split('|'),0,{}))
...
function del_item(data_id){
    $(".cart-list li[data-id='"+data_id+"']").fadeOut("slow");
       ...
       var query = new Object();
        query.id = data_id;
        query.act = "del_cart";
        query.item_number = parseInt(jsondata[data_id]["number"]);
        $.ajax({
            url:AJAX_URL,
            data:query,
            type:"POST",
